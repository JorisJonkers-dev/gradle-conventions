...
- **Gradle**: declare versions only in `gradle/libs.versions.toml`; reference
  ...
  ```toml
  [versions]
  jorisjonkers-kotlin-commons = "0.6.5"
  [libraries]
...
- **GitHub Actions / reusable workflows**: pin to the org workflow release tag,
  e.g. `uses: JorisJonkers-dev/github-workflows/.github/workflows/jvm-ci.yml@v0.6.0`.
