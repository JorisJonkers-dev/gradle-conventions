...
**Independent Test**: Apply `dev.jorisjonkers.kotlin`, set Java 25 and
`registerResolveAllDependencies`, and assert task/toolchain configuration.

- [x] T005 [US1] Update `plugins/kotlin/src/main/kotlin/dev.jorisjonkers.kotlin.gradle.kts`
...
**Independent Test**: Apply `dev.jorisjonkers.spring`, configure BOM versions, and
assert dependency-management output contains the requested versions.

- [x] T007 [US2] Update `plugins/spring/src/main/kotlin/dev.jorisjonkers.spring.gradle.kts`
...
**Independent Test**: Apply `dev.jorisjonkers.testing`, enable separate
integration coverage, and assert task registration and check wiring.

- [x] T009 [US3] Update `plugins/testing/src/main/kotlin/dev.jorisjonkers.testing.gradle.kts`
...
- [x] T011 [P] [US4] Update `plugins/detekt/src/main/kotlin/dev.jorisjonkers.detekt.gradle.kts`
- [x] T012 [P] [US4] Update `plugins/ktlint/src/main/kotlin/dev.jorisjonkers.ktlint.gradle.kts`
